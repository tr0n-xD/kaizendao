...
export function PersonRow(props: {person: Person, selectPerson: any}) {
    ...
    return (
        <div className='flexRow justifyStart gap5' style={{width: '250px', color: 'black', backgroundColor: '#fbf82e', borderRadius: '10px', padding: '5px 10px 5px 10px', fontSize: '15px', textAlign: 'left'}}>
